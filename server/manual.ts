...
export const MANUAL_PAGES: Record<string, ManualPage> = {
  ...
  update: {
    name: "update",
    synopsis: "/update  |  /update apply",
    description: "Check for updates from the official repository and apply them safely via fast-forward. The updater refuses dirty checkouts or unexpected remote URLs.",
    examples: ["/update", "/update apply"],
    safety: "Only fast-forwards clean checkouts tracking https://github.com/RootedMani/Miss-Data.git.",
    aliases: ["upgrade"],
  },
  troubleshooting: {
